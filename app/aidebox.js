...
/******/ 	var hotCurrentHash = "c1e64592b6704e6c397c"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _electron = __webpack_require__(213);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var store = (0, _redux.createStore)(_reducers2.default, (0, _initialState2.default)(), (0, _redux.applyMiddleware)(_reduxThunk2.default));
	
	// Load full application list
	_electron.ipcRenderer.on('newAppList', function (event, apps) {
	    if (apps.length > 0) {
	        store.dispatch({
	            type: 'NEW_APP_LIST',
	            apps: apps
	...
	_electron.ipcRenderer.send('updateAppList');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommonSearch = __webpack_require__(195);
	...
	var App = _react2.default.createClass({
	    ...
	    propTypes: {
	        system: _react2.default.PropTypes.object.isRequired
	    },
	    ...
	    render: function render() {
	        ...
	        if (system.activeModule == 'commonSearch') {
	            return _react2.default.createElement(_CommonSearch2.default, null);
	        }
	    }
	});
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onNavigation: function onNavigation(direction) {
	            dispatch(_actions2.default.performNavigation(direction));
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Box = __webpack_require__(197);
	
	var _Box2 = _interopRequireDefault(_Box);
	
	var _MainMenu = __webpack_require__(198);
	
	var _MainMenu2 = _interopRequireDefault(_MainMenu);
	
	var _searchInput = __webpack_require__(200);
	
	var _searchInput2 = _interopRequireDefault(_searchInput);
	
	var _commonList = __webpack_require__(204);
	
	var _commonList2 = _interopRequireDefault(_commonList);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var CommonSearch = _react2.default.createClass({
	    displayName: 'CommonSearch',
	
	
	    render: function render() {
	        return _react2.default.createElement(
	            _Layout2.default,
	            { type: 'row', classes: 'main-layout' },
	            _react2.default.createElement(
	                _Box2.default,
	                { width: '80px', classes: 'border-bottom-dark' },
	                _react2.default.createElement(_MainMenu2.default, null)
	            ),
	            _react2.default.createElement(
	                _Layout2.default,
	                { type: 'column', classes: 'border-top-light' },
	                _react2.default.createElement(
	                    _Box2.default,
	                    { height: '70px', classes: 'border-bottom-dark' },
	                    _react2.default.createElement(_searchInput2.default, { classes: 'main-search-input' })
	                ),
	                _react2.default.createElement(
	                    _Layout2.default,
	                    { classes: 'border-top-light' },
	                    _react2.default.createElement(
	                        _Box2.default,
	                        { width: '350px', classes: 'border-right-dark' },
	                        _react2.default.createElement(_commonList2.default, null)
	                    ),
	                    _react2.default.createElement(
	                        _Layout2.default,
	                        { type: 'column', classes: 'border-left-light' },
	                        ' '
	                    )
	                )
	            )
	...
	var Layout = function (_React$Component) {
	    ...
	    _createClass(Layout, [{
	        ...
	        value: function render() {
	            ...
	            var direction = !! ~directions.indexOf(this.props['type']) ? this.props['type'] : 'row';
	
	            var classes = ['tiny-Layout'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainMenu = function (_React$Component) {
	    ...
	    function MainMenu() {
	        ...
	        _this.handleMenuActivation = _this.handleMenuActivation.bind(_this);
	        return _this;
	    }
	
	    _createClass(MainMenu, [{
	        key: 'handleMenuActivation',
	        value: function handleMenuActivation() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'main-menu-button', onClick: this.handleMenuActivation },
	                            ' '
	                        )
	                    ),
	                    _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StretchInput = __webpack_require__(201);
	
	var _StretchInput2 = _interopRequireDefault(_StretchInput);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onValChanged: function onValChanged(event) {
	            dispatch(_actions2.default.newSearchQuery(event.target.value));
	        }
	    };
	};
	
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_StretchInput2.default);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StretchInput = function (_React$Component) {
	    _inherits(StretchInput, _React$Component);
	
	    function StretchInput() {
	        _classCallCheck(this, StretchInput);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(StretchInput).apply(this, arguments));
	    }
	
	    _createClass(StretchInput, [{
	        ...
	        value: function render() {
	            ...
	            var contStyle = this.props['style'] ? this.props['style'] : {};
	            var inputStyle = {};
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: classes.join(' '), style: contStyle },
	...
	StretchInput.propTypes = {
	    onValChanged: _react2.default.PropTypes.func.isRequired
	};
	exports.default = StretchInput;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    updateAppList: function updateAppList(apps) {
	        return {
	            type: _types2.default.NEW_APP_LIST,
	            apps: apps
	        };
	    },
	
	    newSearchQuery: function newSearchQuery(query) {
	        return {
	            type: _types2.default.NEW_SEARCH_QUERY,
	            query: query
	        };
	    },
	
	    performNavigation: function performNavigation(direction) {
	        return function (dispatch, getState) {
	
	            var length = getState().applications.filteredList.length;
	            var activeItem = getState().list.activeItem;
	            ...
	            // console.log(length, activeItem);
	
	            dispatch({
	                type: _types2.default.PERFORM_NAVIGATION,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GroupList = __webpack_require__(205);
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps /*, mapDispatchToProps*/)(_GroupList2.default);
	module.exports = exports['default'];
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.list.map(function (item) {
	                    index++;
	                    return _react2.default.createElement(_ListItem2.default, { key: item.iid, item: item, active: index == activeItem ? 1 : 0 });
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListItem = function (_React$Component) {
	    ...
	    _createClass(ListItem, [{
	        ...
	        key: "_createSVG",
	        value: function _createSVG(svgString) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _system = __webpack_require__(208);
	
	var _system2 = _interopRequireDefault(_system);
	
	var _applications = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Matcher = __webpack_require__(211);
	
	var _Matcher2 = _interopRequireDefault(_Matcher);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var matcher = new _Matcher2.default();
	
	var getFilteredItems = function getFilteredItems(apps) {
	    var fullRes = void 0;
	    var result = [];
	    var maxResCount = 16;
	    var i = 0;
	    ...
	    fullRes = apps.list.filter(function (app) {
	...
	var reducer = function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case _types2.default.NEW_APP_LIST:
	            {
	                newState.list = action.apps;
	                return newState;
	            }
	
	        case _types2.default.NEW_SEARCH_QUERY:
	            {
...
/***/ function(module, exports) {
	...
	var Matcher = function () {
	    ...
	    _createClass(Matcher, [{
	        key: "setWorkQuery",
	        value: function setWorkQuery(query) {
	        ...
	        key: "_getTestRegExp",
	        value: function _getTestRegExp(query) {
	            var pattern = "",
	                i = void 0,
	                expr = void 0;
	        ...
	        key: "testByQuery",
	        value: function testByQuery(query, target) {
	            var regexp = Matcher._getTestRegExp(query),
	                mResult = void 0,
	                testRes = false;
	        ...
	        key: "testByRegExp",
	        value: function testByRegExp(regExp, target) {
	            var regexp = regExp,
	                mResult = void 0,
	                testRes = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducer = function reducer() {
	    ...
	    switch (action.type) {
	        ...
	        case _types2.default.PERFORM_NAVIGATION:
	            {
...
/***/ }
/******/ ]);
//# sourceMappingURL=aidebox.js.map